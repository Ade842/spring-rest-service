...
public class AdvertisementIntegrationTest {
  ...
  @Test
  public void createAdvertisementFailure2() throws JSONException {
    Faker faker = new Faker();
    String randomName = faker.name().firstName();
    String randomSurname = faker.name().lastName();
    String randomPhone = faker.phoneNumber().phoneNumber();
    ...
    newAdvertisement.put("title", randomTitle);
    newAdvertisement.put("description", "description" + randomTitle);
    newAdvertisement.put("userId",id);
    newAdvertisement.put("categoryId", categoryId);
    validatableResponse1 = given()
        .contentType(ContentType.JSON)
        .when()
  ...
  @Test
  public void createAdvertisementFailure3() throws JSONException {
    int userId = getUserId();
    Faker faker = new Faker();
    String randomName = faker.name().title();
    ...
    newAdvertisement.put("description", "description" + randomTitle);
    newAdvertisement.put("userId",getUserId());
    newAdvertisement.put("categoryId", id);
    validatableResponse1 = given()
        .contentType(ContentType.JSON)
        .when()
        .post("/advertisements/")
